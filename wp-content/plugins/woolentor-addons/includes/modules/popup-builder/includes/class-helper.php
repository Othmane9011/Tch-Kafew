    ...
    public static function generate_inline_css( $popup_id, $popup_settings, $place ){
        ...
        if( $place == 'popup_close_button' ){
            if( is_array($popup_settings['close_button_vertical_position']) 
                && !empty($popup_settings['close_button_vertical_position'])
                && $popup_settings['close_button_vertical_position']['amount']
                && $popup_settings['close_button_vertical_position']['unit']
            ){
            ...
            if( is_array($popup_settings['close_button_horizontal_position']) 
                && !empty($popup_settings['close_button_horizontal_position'])
                && $popup_settings['close_button_horizontal_position']['amount']
                && $popup_settings['close_button_horizontal_position']['unit']
            ){
